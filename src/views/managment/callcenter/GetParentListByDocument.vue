                    ...
                    <table>
                        <tbody>
                            <tr>
                                ...
                                <td class="pb-1"><span class="font-weight-bold"> {{ items[0].kinshipdegreename }} </span></td>
                            </tr>
                            <tr>
                                <td class="pr-1 pb-1">
                                    {{ $t('mfyname') }} :
                                </td>
                                <td class="font-weight-bold pb-1"> {{ items[0].mfyname }} </td>
                            </tr>
                            <tr>
                                <td class="pr-1 pb-1">
                                    {{ $t('livestreetname') }} :
                                </td>
                                <td class="font-weight-bold pb-1"> {{ items[0].livestreetname }} </td>
                            </tr>
                            <tr>
                                <td class="pr-1 pb-1">
                                    {{ $t('livestreethousename') }} :
                                </td>
                                <td class="font-weight-bold pb-1"> {{ items[0].livestreethousename }} </td>
                            </tr>
                        </tbody>
                    </table>
                </b-card>
    ...
    return {
      ...
      fields: [
        ...
        },
        {
          ...
          label: this.$t("kinshipdegreename"),
          thClass: "text-center",
          tdClass: "text-center",
          sortable: true,
        },
        ...
        {
          key: "livestreetname",
          label: this.$t("livestreetname"),
          thClass: "text-center",
          sortable: true,
        },
        {
          key: "livestreethousename",
          label: this.$t("livestreethousename"),
          thClass: "text-center",
          sortable: true,
        },
        {
