        ...
        <b-row>
          ...
          >
            <b-button
              ...
              variant="primary"
              :to="{ name: 'Editeduform', params: { id: 0 } }"
            >
          ...
          <template #cell(actions)="{ item }">
            <div class="text-center">
              <b-link
                ...
                :to="{ name: 'Editeduform', params: { id: item.id } }"
...
<script>
import EduFormService from "@/services/info/eduform.service";
...
export default {
  ...
  data() {
    return {
      ...
      fields: [
        ...
        {
          key: "hemisExternalCode",
          label: this.$t("hemisExternalCode"),
          thClass: "text-center",
          tdClass: "text-center",
          sortable: true,
        },
  ...
  methods: {
    ...
    Edit(item) {
      this.$router.push({ path: "/info/eduform/edit/" + item.id });
    },
    Refresh() {
      this.isBusy = true;
      EduFormService.GetList(this.filter).then((res) => {
