        ...
        <b-row>
          ...
          >
            <b-button
              ...
              variant="primary"
              :to="{ name: 'Editnationality', params: { id: 0 } }"
            >
          ...
          <template #cell(actions)="{ item }">
            <div class="text-center">
              <b-link
                ...
                :to="{ name: 'Editnationality', params: { id: item.id } }"
...
export default {
  ...
  methods: {
    ...
    Delete(item) {
      ...
      NationalityService.Delete(item.id)
        .then((res) => {
    ...
    Edit(item) {
      this.$router.push({ path: "/info/nationality/edit/" + item.id });
    },
    Refresh() {
      this.isBusy = true;
      NationalityService.GetList(this.filter).then((res) => {
