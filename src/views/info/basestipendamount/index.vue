        ...
        <b-row>
          ...
          >
            <b-button
              ...
              variant="primary"
              :to="{ name: 'Editbasestipendamount', params: { id: 0 } }"
            >
          ...
          <template #cell(actions)="{ item }">
            <div class="text-center">
              <b-link
                ...
                :to="{ name: 'Editbasestipendamount', params: { id: item.id } }"
...
export default {
  ...
  data() {
    return {
      ...
      fields: [
        ...
        {
          key: "amount",
          label: this.$t("basestipendamountamount"),
          thClass: "text-center",
          tdClass: "text-center",
          sortable: true,
        },
  ...
  methods: {
    ...
    Delete(item) {
      ...
      BaseStipendAmountService.Delete(item.id)
        .then((res) => {
    ...
    Edit(item) {
      ...
      this.$router.push({ path: "/info/basestipendamount/edit/" + item.id });
    },
    Refresh() {
      this.isBusy = true;
      BaseStipendAmountService.GetList(this.filter).then((res) => {
