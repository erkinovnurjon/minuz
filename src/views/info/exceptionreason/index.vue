        ...
        <b-row>
          ...
          >
            <b-button
              ...
              variant="primary"
              :to="{ name: 'Editexceptionreason', params: { id: 0 } }"
            >
          ...
          <template #cell(actions)="{ item }">
            <div class="text-center">
              <b-link
                ...
                :to="{ name: 'Editexceptionreason', params: { id: item.id } }"
...
export default {
  ...
  methods: {
    ...
    Delete(item) {
      ...
      ExceptionReasonService.Delete(item.id)
        .then((res) => {
    ...
    Edit(item) {
      ...
      this.$router.push({ path: "/info/exceptionreason/edit/" + item.id });
    },
    Refresh() {
      this.isBusy = true;
      ExceptionReasonService.GetList(this.filter).then((res) => {
