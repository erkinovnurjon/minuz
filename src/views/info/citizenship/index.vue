        ...
        <b-row>
          ...
          >
            <b-button
              ...
              variant="primary"
              :to="{ name: 'Editcitizenship', params: { id: 0 } }"
            >
          ...
          <template #cell(actions)="{ item }">
            <div class="text-center">
              <b-link
                ...
                :to="{ name: 'Editcitizenship', params: { id: item.id } }"
...
export default {
  ...
  methods: {
    ...
    Delete(item) {
      ...
      CitizenshipService.Delete(item.id)
        .then((res) => {
    ...
    Edit(item) {
      this.$router.push({ path: "/info/citizenship/edit/" + item.id });
    },
    Refresh() {
      this.isBusy = true;
      CitizenshipService.GetList(this.filter).then((res) => {
